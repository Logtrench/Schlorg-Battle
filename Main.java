...
class Main {
  ...
  public static void main(String[] args) {
    ...
    // calls upon play once to initialize. play requires no parameters which is why
    // it is prefered over main
    play();
  ...
  public static void play() {
    ...
    switch (slide) {
      ...
      case 2:
        ...
        break;
      case 3:
        // the fight slide, ability to attack or go to the shop, sets invisible incase
        // you meet and end condition
        GUI.Fight();
        break;
      case 4:
      ...
      case 5:
        ...
        break;
      case 6:
        // the king end slide, if you choose to refuse the bears offer, this is one of
        // three endings

        GUI.KingEnd();
        break;
      case 7:
        // the bear end slide, if you choose to join the bear, this is one of three
        // endings
      ...
      case 8:
        ...
        break;
      case 9:
        // the end slide, you have finished the game and are given the option to play
        // again.

        GUI.end();
        break;
      case 10:
        // the both lose slide, this is the secret ending of the three. It is very hard
        // to get. The sad ending
      ...
      case 12:
        //The scoreboard adder

        GUI.Scoreboard();

        //The SCoreBoard class should be called from a GUI.Scoreboard button
        
        break;
      default:
        // This simply should never be called. The println is very useful for finding a
        // specific bug in this switch case.
